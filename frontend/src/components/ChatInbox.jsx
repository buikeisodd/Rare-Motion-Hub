...
function normalizeMessage(value) {
  ...
  return { ...value, id: value.id, text, storyLabel: value.storyId ? 'Story reply' : '', deleted: Boolean(value.deleted), senderId: value.senderId || '', sender: normalizeUser(value.sender), createdAt: value.createdAt || new Date().toISOString() };
}
