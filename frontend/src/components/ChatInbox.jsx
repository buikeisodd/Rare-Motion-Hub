...
export default function ChatInbox({ user, isOpen, onToggle, startConversationWith, onOpenStory }) {
  ...
  const [starredForMenu, setStarredForMenu] = useState([]);
  ...
  const openChatMenu = () => { setMenuConversation(active); setStarredForMenu(messages.filter((message) => message.starred)); setActive(null); setMessages([]); setReplyingTo(null); setMessageMenu(null); setChatMenuOpen(true); };
