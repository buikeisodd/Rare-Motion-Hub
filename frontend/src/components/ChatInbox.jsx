...
import { ArrowLeft, CheckCheck, Copy, Inbox, MessageCircle, MoreVertical, Pin, Reply, Search, Send, Star, Trash2, UserPlus, Users, X } from 'lucide-react';
...
export default function ChatInbox({ user, isOpen, onToggle, startConversationWith, onOpenStory }) {
  ...
  return <div className="fixed inset-0 z-[80] flex bg-primary-background/80 p-0 backdrop-blur-xl sm:items-center sm:justify-center sm:p-5" onClick={onToggle}>
    <div className="panel-bg flex h-full w-full overflow-hidden border-border sm:h-[min(42rem,90vh)] sm:max-w-4xl sm:rounded-3xl sm:border sm:shadow-2xl" onClick={(event) => event.stopPropagation()}>
