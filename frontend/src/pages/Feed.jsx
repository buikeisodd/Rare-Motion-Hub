                ...
                <div key={person.id} className="group relative flex items-center gap-2.5">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    <button
                      ...
                      className="grid h-6 w-6 place-items-center rounded-full text-secondary-label opacity-60 transition-colors hover:bg-accent hover:text-[#050505] hover:opacity-100"
...
export default function Feed({ user, savedOnly = false }) {
  ...
  return <div className="min-h-screen bg-[#050505] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#1a0d06] via-[#050505] to-[#050505] pb-24 text-[#F7F4EC] md:pb-0">
