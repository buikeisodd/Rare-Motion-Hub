...
export default function Folder({ user, onLogout }) {
  ...
  return (
    <div className="min-h-screen bg-primary-background px-4 py-4 pb-32 text-primary-label sm:px-8 sm:py-6 md:pb-28 lg:px-14 lg:py-8">
      {isAddMenuOpen && (
      ...
      <div className={`fixed bottom-6 z-[60] hidden md:flex flex-col items-end ${currentTrack ? 'left-6' : 'right-4 sm:right-8 lg:right-12'}`}>
        ...
        <button
          ...
          className="grid h-12 w-12 place-items-center rounded-xl bg-accent text-primary-background shadow-2xl transition-transform hover:bg-accent-hover hover:scale-105"
          aria-label="Add"
        >
