...
export default function Live({ user }) {
  ...
  useEffect(() => {
    ...
    connect();
    return () => { cancelled = true; setConnected(false); setPublishing(false); setVideoUnavailable(false); room?.disconnect(); document.getElementById('live-media-stage')?.replaceChildren(); };
  }, [active]);
