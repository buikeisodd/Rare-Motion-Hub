    ...
    const connect = async () => {
      try {
        ...
        const attachTrack = (track) => {
          ...
          if (track.kind === Track.Kind.Video) element.className = 'h-full min-h-[16rem] w-full rounded-xl object-contain md:w-[calc(50%-0.5rem)]';
        ...
        if (data.canPublish) {
          ...
          room.localParticipant.videoTrackPublications.forEach((publication) => {
            ...
            if (element) {
              element.className = 'h-full min-h-[16rem] w-full rounded-xl object-cover md:w-[calc(50%-0.5rem)]';
              document.getElementById('live-media-stage')?.appendChild(element);
            }
          });
        }
