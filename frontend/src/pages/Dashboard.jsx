        ...
        >
          ...
          {leadTrack && (
            <button 
              ...
              className="absolute bottom-3 right-3 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-accent text-primary-background shadow-xl transition-transform hover:bg-accent-hover hover:scale-110 group-hover:scale-105"
            >
...
function NotificationsMenu({ isOpen, notifications, conversations, onRead, onClear }) {
          ...
          {visibleNotifications.length === 0 ? (
            ...
            <div className="max-h-96 space-y-2 overflow-y-auto hide-scrollbar">
              {visibleNotifications.map((notification) => {
                const text = notification.type === 'chat' || notification.type === 'message' || notification.type === 'call' || notification.type === 'like' || notification.type === 'story_like' || notification.type === 'comment' || notification.type === 'comment_like' || notification.type === 'comment_reply' || notification.type === 'comment_mention' || notification.type === 'follow' || notification.type === 'follow_confirmation'
