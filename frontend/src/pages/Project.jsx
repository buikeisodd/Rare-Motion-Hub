...
export default function Project({ user }) {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#050505] via-[#050505] to-[#050505] pb-32 text-[#F7F4EC] md:pb-10">
      {isProjectMenuOpen && (
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex shrink-0 items-center gap-3">
                ...
                <button
                  ...
                  className="grid h-12 w-12 place-items-center rounded-full bg-accent text-primary-background transition-transform hover:bg-accent-hover hover:scale-105"
      ...
      {isOwner && <button
        onClick={() => setIsUploadOpen(true)}
                  className={`fixed bottom-6 z-[60] flex items-center gap-2 rounded-full bg-primary-label px-5 py-3 text-sm font-semibold text-primary-background shadow-2xl transition-transform hover:scale-105 ${currentTrack ? 'left-3 sm:left-6' : 'left-1/2 -translate-x-1/2 sm:left-auto sm:right-8 sm:translate-x-0'}`}
