            ...
            {tracks.length === 0 && !uploadingTrack ? (
              ...
              tracks.map((track, index) => (
                <div
                  ...
                  className={`project-track-row group grid cursor-pointer grid-cols-[2rem_1fr_auto] items-center gap-3 rounded-xl px-3 py-2.5 text-[#F3EBDD] transition-all ${currentTrack?.id === track.id ? 'project-track-row-active' : 'hover:bg-shading'} ${dragTrackId === track.id ? 'ring-2 ring-primary-label/40 bg-highlight' : ''}`}
                >
