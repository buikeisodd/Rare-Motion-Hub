    ...
    <div className="min-h-screen bg-primary-background px-4 pb-32 text-primary-label sm:px-8 md:pb-20">
      ...
      <main className="profile-dossier mx-auto max-w-5xl py-8 sm:py-12">
        ...
        <section className="profile-dossier-hero grid gap-7 rounded-[2rem] border border-border bg-shading/35 p-5 shadow-sm sm:grid-cols-[12rem_1fr] sm:gap-10 sm:p-8 lg:grid-cols-[15rem_1fr] lg:gap-14">
          <div className="mx-auto sm:mx-0"><UserAvatar user={profile} size="h-36 w-36 sm:h-48 sm:w-48 lg:h-60 lg:w-60" className="rounded-[2rem] ring-1 ring-border" /></div>`r`n          <div className="min-w-0">
