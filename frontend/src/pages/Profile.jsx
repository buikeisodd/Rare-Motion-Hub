      ...
      <main className="profile-dossier mx-auto w-full max-w-5xl py-5 sm:py-8">
        ...
        <section className="profile-dossier-hero grid gap-5 rounded-[1.5rem] border border-border bg-shading/35 p-4 shadow-sm sm:grid-cols-[10rem_1fr] sm:gap-7 sm:p-6 lg:grid-cols-[13rem_1fr] lg:gap-10">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-6 grid grid-cols-3 gap-2 border-y border-border py-4 text-sm"><span><strong className="block text-lg">{posts.length}</strong><small className="text-secondary-label">posts</small></span><span><strong className="block text-lg">{profile.followerCount || 0}</strong><small className="text-secondary-label">followers</small></span><span><strong className="block text-lg">{profile.followingCount || 0}</strong><small className="text-secondary-label">following</small></span></div>
