...
export default function Profile({ user, onUserUpdate }) {
  ...
  if (!profile) return (
    <div className="min-h-screen bg-[#050505] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#050505] via-[#050505] to-[#050505] px-4 pb-32 text-[#F7F4EC] sm:px-8 md:pb-20" role="status" aria-label="Loading profile">
  ...
  return (
    <div className="min-h-screen bg-[#050505] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#050505] via-[#050505] to-[#050505] px-4 pb-32 text-[#F7F4EC] sm:px-8 md:pb-20">
