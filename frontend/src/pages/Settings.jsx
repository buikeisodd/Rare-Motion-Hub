...
import { Archive, ArrowLeft, CreditCard, LogOut, Shield, Trash2, UserRound } from 'lucide-react';
...
export default function Settings({ user, onLogout }) {
  ...
  const menuItems = [
    { label: 'Account', icon: UserRound, onClick: () => navigate(`/profile/${user.id}`) },
